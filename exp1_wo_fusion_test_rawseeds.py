...
with open(csvDir + "EXP01_DepthPreprocessingRAWSEEDS.csv", 'a', newline='') as file:
    ...
    for input_type in input_types:
        ...
        #state_dict_path = f"{PARAMS.saved_models_path}EXP03_RAWSEEDS/{input_type}/net.pth"
        ...
        with torch.no_grad():
            ...
            for env in ["25a", "25b", "26a", "26b"]:

                vmDataset = datasets_rawseeds.Database_wo_Fusion(env="27a", input_type=input_type, tf=tf)
                ...
                pkl_path = f"PKL_FILES/no_fusion/{input_type}/{env}.pkl"
            ...
            glob_r1, glob_rn = np.average(recall_at_1), np.average(recall_at_n)
