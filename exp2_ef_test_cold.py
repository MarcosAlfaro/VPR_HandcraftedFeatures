    ...
    for method in ef_methods:
        ...
        with torch.no_grad():
            ...
            for env in envs_COLD:
                ...
                vmDataset = datasets_cold.Database_EF(env=env, ef_method=method, input_type=input_type, tf=tf)
                ...
                for ilum in condIlum:
                    ...
                    testDataset = datasets_cold.Test_EF(il=ilum, env=env, ef_method=method, input_type=input_type, tf=tf)
